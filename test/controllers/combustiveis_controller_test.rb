...
class CombustiveisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create combustivel" do
    assert_difference('Combustivel.count') do
      post combustiveis_url, params: { combustivel: { data_abastecimento: @combustivel.data_abastecimento, litros: @combustivel.litros, placa: @combustivel.placa, valor: @combustivel.valor } }
    end
  ...
  test "should update combustivel" do
    patch combustivel_url(@combustivel), params: { combustivel: { data_abastecimento: @combustivel.data_abastecimento, litros: @combustivel.litros, placa: @combustivel.placa, valor: @combustivel.valor } }
